...
import "@openzeppelin/contracts/utils/Counters.sol";
 // [SECURITY UPDATE 3] Import OZ ReentrancyGuard
...
// [SECURITY UPDATE 3] Add ReentrancyGuard to the contract
contract ApesAirdrop is ERC721, ReentrancyGuard {
    ...
    // [SECURITY UPDATE 3] Add ReentrancyGuard to the mint function
    function mint() external nonReentrant returns (uint16) {
        ...
        // [SECURITY UPDATE 2] Update the claim first (effect), before the minting (interaction)
        // Update claimed
        claimed[msg.sender] = true;
        
        // Mint NFT
        // [SECURITY UPDATE 1] Change from _safeMint to _mint to avoid the reentrancy by smart contract
